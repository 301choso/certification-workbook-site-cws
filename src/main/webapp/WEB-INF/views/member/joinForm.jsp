...
<div class="wrap">
	<div class="login">
		<form name="join_form" action="${contextPath}/member/join.do" method="post" onSubmit="return checkAll(this)">
	    <h2>회원가입</h2>
	   
	    <div class="login_id">
	        <h4>아이디</h4>
	        <input type="text" name="member_id" id="member_id" placeholder="아이디 입력" required>
	    ...
	    <div class="login_pw">
	        <h4>비밀번호 확인</h4>
	        <input type="password" name="member_pw2" id="member_pw2" placeholder="비밀번호 확인">
	    </div>
