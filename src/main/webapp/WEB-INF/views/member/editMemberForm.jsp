...
<div class="wrap">
	<div class="login">
		<form name="edit_form" action="${contextPath}/member/updateMember.do" method="post" onSubmit="return checkAll(this)">
	    <h2>회원 정보 수정</h2>
	    <input type="hidden" name="member_num" id="member_num" value="${list.member_num}" required>
	    <div class="login_id">
	        <h4>아이디</h4>
